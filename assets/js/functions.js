...
(function ($) {
  ...
  var instafeedModule = $("#instafeedModule").length,
    ...
    InstaAccessToken =
      "IGQVJXemRJZAUdRZAnNJc0NEcUpLclZAaaUpBaWRENXRQbUl6ZAlBNaTZAsX1huclk2OWRLMXNEZAEtIMDBtbjF3cWRCMlFjY19iS0NWRnJyV2pRajlYSjllWDUxdjlVcG1zWm9GSXdJRTlOWGVMWjJvZAGZA5WQZDZD"; /*YOUR_ACCESS_TOKEN*/
  if (instafeedModule > 0) {
    var userFeedModule = new Instafeed({
      ...
      template:
        '<a href="{{link}}" target="_blank"><img src="{{image}}" /><div class="insta-hover"><i class="fab fa-instagram"></i></div></a>',
